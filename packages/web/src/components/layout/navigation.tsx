      ...
      <nav className="bg-background shadow-sm border-b border-border" role="navigation" aria-label="Main navigation">
        <div className="container-responsive">
          ...
          <div className="flex items-center">
            ...
            <button
              type="button"
              className="lg:hidden touch-target inline-flex items-center justify-center p-2 rounded-md text-muted-foreground hover:text-muted-foreground/80 hover:bg-muted focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary"
            ...
            >
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xl font-bold text-foreground mobile-hide">Saga</span>
              </div>
            </Link>
