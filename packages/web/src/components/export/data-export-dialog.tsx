      ...
      {step === 'configure' && (
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              <label className="flex items-center space-x-3">
                ...
                <span className="text-xs text-gray-500">(原始录音)</span>
              </label>
              ...
              <label className="flex items-center space-x-3">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                />
                <span className="text-sm font-medium text-gray-700">转录文本</span>
                <span className="text-xs text-gray-500">(AI生成的文字记录)</span>
              </label>
              ...
              <label className="flex items-center space-x-3">
                ...
                <span className="text-xs text-gray-500">(故事中的图片)</span>
              </label>
              ...
              <label className="flex items-center space-x-3">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                />
                <span className="text-sm font-medium text-gray-700">互动记录</span>
                <span className="text-xs text-gray-500">(评论和后续问题)</span>
              </label>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <h4 className="font-medium text-gray-900 mb-2">导出预览</h4>
            {estimatedSize && (
      ...
      {step === 'confirm' && (
        <div className="space-y-6">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">确认导出</h3>
            <p className="text-gray-600 mb-6">
      ...
      {step === 'processing' && (
        <div className="space-y-6">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">正在处理导出</h3>
      ...
      {step === 'complete' && (
        <div className="space-y-6">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">导出完成！</h3>
            <p className="text-gray-600 mb-6">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-center space-x-3">
              ...
              <div className="text-sm">
                ...
                <p className="text-green-700">文件大小: {exportStatus && dataExportService.formatFileSize(estimatedSize?.estimatedSizeMB || 0)}</p>
              </div>
            </div>
          </div>
