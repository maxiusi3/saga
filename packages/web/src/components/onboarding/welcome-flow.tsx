                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-3 p-4 bg-muted rounded-lg">
                      ...
                      <span className="text-muted-foreground">Invite family members to share stories</span>
                    </div>
                    ...
                    <div className="flex items-center space-x-3 p-4 bg-muted rounded-lg">
                      ...
                      <span className="text-muted-foreground">Review and organize collected stories</span>
                    </div>
                  </div>
                </div>
              ) : (
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-3 p-4 bg-muted rounded-lg">
                      ...
                      <span className="text-muted-foreground">Record your stories using our simple interface</span>
                    </div>
                    ...
                    <div className="flex items-center space-x-3 p-4 bg-muted rounded-lg">
                      ...
                      <span className="text-muted-foreground">See your stories preserved for the family</span>
                    </div>
                  </div>
                </div>
              )}
