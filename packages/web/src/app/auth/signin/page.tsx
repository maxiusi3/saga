...
export default function SignInPage() {
  ...
  const { signin, googleSignIn, appleSignIn, isLoading, error, clearError } = useAuthStore()
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-3">
                    <button
                      ...
                      disabled={isLoading}
                      className="text-xs bg-blue-100 hover:bg-blue-200 text-blue-800 px-3 py-1 rounded-md transition-colors disabled:opacity-50"
                    >
              ...
              <div className="rounded-md bg-red-50 p-4">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-red-600 mt-1">Please use one of the demo accounts above or check your credentials.</p>
                  </div>
                </div>
              </div>
            )}
