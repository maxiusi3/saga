...
exports.getNotificationDisplayInfo = getNotificationDisplayInfo;
exports.formatNotificationTime = formatNotificationTime;
exports.groupNotifications = groupNotifications;
exports.createNotificationSummary = createNotificationSummary;
exports.generateNotificationMessage = generateNotificationMessage;
exports.shouldReceiveNotification = shouldReceiveNotification;
/**
 * Get notification display information
 */
function getNotificationDisplayInfo(type) {
    switch (type) {
        case 'new_story':
            return {
                icon: '📖',
...
function groupNotifications(notifications) {
    ...
    return Array.from(groups.values()).sort((a, b) => new Date(b.latest_notification.created_at).getTime() -
 ...
 */
function shouldReceiveNotification(notificationType, userRole, isProjectOwner, isStoryteller, settings) {
