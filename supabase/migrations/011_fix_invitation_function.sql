-- Fix send_project_invitation function to check both projects.facilitator_id and project_roles
-- This addresses the issue where users can't send invitations due to missing project_roles records

BEGIN;

-- Update the send_project_invitation function
